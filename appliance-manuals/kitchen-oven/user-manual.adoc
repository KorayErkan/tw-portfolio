...
image::kitchen-oven-clearances.png[Installation clearances with measurements, width=70%]
...
image::kitchen-oven-troubleshooting.png[Troubleshooting diagnostic flowchart, width=70%]
