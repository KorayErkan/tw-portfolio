...
image::oven-clearances.png[Installation clearances with measurements, width=65%]
...
image::oven-controls.png[Control panel with numbered callouts, width=50%]
...
image::oven-exploded.png[Exploded view with numbered parts, width=50%]
