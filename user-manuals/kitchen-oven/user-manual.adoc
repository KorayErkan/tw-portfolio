...
image::kitchen-oven-clearances.png[Installation clearances with measurements, width=65%]
...
==== 4. Initial Power-On and Testing
...
image::kitchen-oven-controls.png[Control panel with numbered callouts, width=50%]
...
image::kitchen-oven-exploded.png[Exploded view with numbered parts, width=50%]
...
image::kitchen-oven-troubleshooting.png[Troubleshooting diagnostic flowchart, width=30%]
...
* Any gas odor (if near gas appliances) - evacuate and call gas company immediately
